...
export function Header({ title, subtitle, actions }: HeaderProps) {
  return (
    <div className="flex min-h-[52px] shrink-0 flex-wrap items-center gap-x-3 gap-y-1 border-b border-[#31415f] bg-[#17233f] px-3 py-2 text-white sm:h-[52px] sm:flex-nowrap sm:px-5 sm:py-0">
