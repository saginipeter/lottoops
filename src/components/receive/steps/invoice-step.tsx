...
export function InvoiceStep({ shipment, setShipment, nextStep, onCancel }: InvoiceStepProps) {
  ...
  return <Panel className="p-4 sm:p-5">
    ...
    <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
      ...
      <Field label="Expected inventory cost" icon={<Package size={15} />} hint="Calculated automatically after packs are scanned: 95% of face value"><div className="flex h-11 items-center border border-border bg-muted/20 px-3 text-sm text-text-secondary">Calculated after scan</div></Field>
    </div>
