...
export function PageToolbar({ left, center, right, className }: PageToolbarProps) {
  return (
    <div
      className={cn(
        "grid min-h-12 shrink-0 grid-cols-1 items-center gap-2 border-b border-[#d9deea] bg-[#eef1f6] px-3 py-2 sm:h-12 sm:grid-cols-[1fr_auto_1fr] sm:gap-3 sm:px-5 sm:py-0",
        className
      )}
    >
